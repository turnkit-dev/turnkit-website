...
export default function HomePage() {
  return (
    <>
      <nav className="fixed left-0 top-0 z-50 flex h-[60px] w-full items-center justify-between border-b border-border bg-[rgba(8,12,16,0.85)] px-[clamp(16px,4vw,64px)] backdrop-blur-xl">
